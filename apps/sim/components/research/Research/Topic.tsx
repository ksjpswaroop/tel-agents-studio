...
function Topic() {
  ...
  function handleCheck(): boolean {
    ...
    console.log('=== DEBUG handleCheck ===');
    console.log('Environment GOOGLE_GENERATIVE_AI_API_KEY:', process.env.GOOGLE_GENERATIVE_AI_API_KEY ? 'EXISTS' : 'MISSING');
    console.log('Environment NEXT_PUBLIC_DEFAULT_MODE:', process.env.NEXT_PUBLIC_DEFAULT_MODE);
    
    const settingStore = useSettingStore.getState();
    console.log('Setting store mode:', settingStore.mode);
