                ...
                >
                  <div className='flex items-center gap-3'>
                    <div className='relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-blue-500'>
                      {userData.isLoggedIn ? (
                        <div className='flex h-full w-full items-center justify-center bg-[#1877F2]'>
                    ...
                    {accounts.length > 1 && (
                      <>
                        ...
                        {accounts.map((account) => (
                          ...
                          >
                            <div className='relative flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#1877F2]'>
