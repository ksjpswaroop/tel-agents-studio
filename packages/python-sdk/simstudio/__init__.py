"""
TEL Cognitive Platform SDK for Python

Official Python SDK for TEL Cognitive Platform, allowing you to execute workflows programmatically.
"""
...
class SimStudioError(Exception):
    """Exception raised for TEL Cognitive Platform API errors."""
...
class SimStudioClient:
    """
    TEL Cognitive Platform API client for executing workflows programmatically.

    Args:
        api_key: Your TEL Cognitive Platform API key
        base_url: Base URL for the TEL Cognitive Platform API (defaults to https://simstudio.ai)
    """
